...
# Metadatos de Shazam → extraído a shazam_service.py (M1)
from shazam_service import (  # noqa: E402
    SHAZAM_CACHE_FILE, _shazam_lookup, _shazam_cache_load, _shazam_cache_save,
)
